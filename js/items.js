...
console.log("Item: " + items[i].name);
  console.log("  Image Path: " + items[i].image);
  console.log("  Model Path: " + items[i].model);
...
// $(document).ready(function() {
//   const baseUrl = 'http://localhost:5000/'; // Adjust if your backend is on another host/port
...
//         // Normalize Windows-style backslashes (if any)
//         var imagePath = item.image.replace(/\\/g, '/');
//         var modelPath = item.model.replace(/\\/g, '/');

//         // Debug log paths
//         console.log(`🖼️ Image Path [${item.name}]:`, baseUrl + imagePath);
//         console.log(`📦 Model Path [${item.name}]:`, baseUrl + modelPath);
