...
(function (BP3D) {
    ...
    (function (Floorplanner) {
        ...
        // grid parameters
        var gridSpacing = 45; // increased from 40 to 80 pixels
        var gridWidth = 2;
        ...
        var wallColor = "#6B7280";
        var wallColorHover = "#008cba";
        var edgeColor = "#888999";
    ...
    (function (Floorplanner_1) {
        ...
        var Floorplanner = (function () {
            ...
            function Floorplanner(canvas, floorplan) {
                ...
                this.wallWidth = 20.0 * this.pixelsPerCm;
                // Initialization:
...
console.log("Spacesketch " + BP3D.Core.Version.getInformalVersion()
